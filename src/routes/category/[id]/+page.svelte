...
<div class="mx-auto container px-6 xl:px-0 py-12">
    <div class="flex flex-col"> 
        <div class="flex flex-col justify-center">
            <div class="relative">
                <img class="hidden sm:block object-cover w-full h-52" src="https://images.unsplash.com/photo-1682685797208-c741d58c2eff?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="ando" />
                <img class="sm:hidden object-cover w-full h-52" src="https://images.unsplash.com/photo-1682685797208-c741d58c2eff?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="ando" />
...
{:else}
	<Page404 />
{/if}
<Seo  title="ANDO - Sản phẩm lọc theo danh sách " description="Chào mừng đến với ANDO - nơi tinh túy nước hoa hội tụ!
