...
<footer class="footer p-10 bg-base-200 text-base-content">
    <div>
      ...
      <p>CÔNG TY TNHH ANDO PERFUME<br/>Tinh tế trên từng note hương</p>
    </div> 
    <div>
      <span class="footer-title">Công ty</span> 
      <a href="/about" class="link link-hover">Về chúng tôi</a> 
      <a href="/contact" class="link link-hover">Liên hệ</a> 
      <a href="/faq" class="link link-hover">Chính sách đổi trả</a> 
    </div> 
    <div>
      <span class="footer-title">Về sản phẩn</span> 
      <a  href="/" class="link link-hover">Cam kết bán hàng</a> 
      <a href="/" class="link link-hover">Mua hàng & vận chuyển</a> 
      <a href="/"class="link link-hover">Chính sách bảo hành</a> 
    </div> 
    <div>
